...
if __name__ == "__main__":
    ...
    for epoch in range(1, hp.Epoch + 1):
        ...
        for trian_i, train_data in trian_pbar:
            ...
            optimizer.zero_grad()
            predicted_interaction,train_loss = model(trian_compounds, num_atoms, trian_proteins,trian_labels)
        ...
        with torch.no_grad():
            for valid_i, valid_data in valid_pbar:
                ...
                valid_scores,valid_loss = model(valid_compounds, num_atoms, valid_proteins,valid_labels)
